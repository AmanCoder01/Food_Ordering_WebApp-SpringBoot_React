...
export const authReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case ADD_TO_FAVORITE_SUCCESS:
            return { ...state, isLoading: false, error: null, favorites: action.payload, success: "Register Success" }

        case GET_USER_SUCCESS:
            return { ...state, isLoading: false, user: action.payload, success: "User Fetched Successfully" }
